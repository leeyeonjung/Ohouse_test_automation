# tests/src/locaters/login_page_locaters.py
...
# 카카오 로그인 버튼
login_button_kakao = "net.bucketplace:id/kakaoLoginButton"

# 네이버 로그인 버튼
login_button_naver = "net.bucketplace:id/naverLoginButton"

# 페이스북 로그인 버튼
login_button_facebook = "net.bucketplace:id/facebookLoginButton"
